...
// y = A * x (float)
[[nodiscard]] inline std::vector<float> sgemvm(size_t rows,
                                               size_t cols,
...
// y = A * x (double)
[[nodiscard]] inline std::vector<double> dgemvm(size_t rows,
                                                size_t cols,
...
// y = x * A (float)
[[nodiscard]] inline std::vector<float> sgevmm(size_t rows,
                                               size_t cols,
                                               const std::vector<float> &matrix,
                                               const std::vector<float> &vec) {
...
// y = x * A (double)
[[nodiscard]] inline std::vector<double> dgevmm(size_t rows,
                                                size_t cols,
                                                const std::vector<double> &matrix,
                                                const std::vector<double> &vec) {
